 ...
 * @returns {Promise} 请求的 Promise 对象 （true/false）。
 */
export function addOrPutObj(obj?: Object) {
  return request({
    url: '/device/iotPoint/saveOrUpdate',
    method: 'post',
    data: obj
  })
}
 ...
 * @returns {Promise} 请求的 Promise 对象数组。
 */
export function getPointDetailByDeviceId(obj?: Object) {
  return request({
    url: '/device/iotPoint/getPointDetailByDeviceId',
    method: 'get',
    params: obj
  })
}
