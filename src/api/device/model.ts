 ...
 * @returns {Promise} 请求的 Promise 对象数组
 */
export function getModelByProduct(productId: string, deviceId: string) {
    return request({
        url: `/device/model/getModelByProduct/${productId}/${deviceId}`,
        method: 'get'
    })
}
 ...
 * @returns {Promise} 请求的 Promise 对象。
 */
export function importModelByTemplate(obj?: Object) {
    return request({
        url: '/device/model/importModelByTemplate',
        method: 'post',
        data: obj
    })
}
