      ...
      <el-row :gutter="24">
        ...
        <el-col :span="12" class="mb20">
          <el-form-item label="描述信息" prop="message">
            <el-input v-model="form.message" placeholder="请输入描述信息" />
          </el-form-item>
        </el-col>

        <el-col :span="12" class="mb20">
          <el-form-item label="处理状态（0未处理、1处理、2不需要处理）" prop="handleStatus">
            <el-select v-model="form.handleStatus" placeholder="请选择处理状态" clearable>
              <el-option label="未处理" value="0" />
              <el-option label="处理" value="1" />
              <el-option label="不需要处理" value="2" />
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
...
<script setup lang="ts" name="IotAlarmRecordDialog">
import { useDict } from '/@/hooks/dict';
import { useMessage } from "/@/hooks/message";
import { getObj, addObj, putObj, validateExist } from '/@/api/device/alarmRecord'
...
// 初始化表单数据
const getIotAlarmRecordData = (id: string) => {
  // 获取数据
  loading.value = true
